...
/**
 * A statement wrapper that monitors execution time.
 */
public class MonitoredStatement implements Statement {

    protected final Statement delegate;
    protected final QueryStatistics statistics;

    /**
     * Create a new monitored statement
     *
     * @param delegate The actual JDBC statement
     * @param statistics The query statistics tracker
     */
    public MonitoredStatement(Statement delegate, QueryStatistics statistics) {
    ...
    public int[] executeBatch() throws SQLException {
        ...
        try {
            ...
            if (statistics != null) {
                statistics.recordBatchOperation(result.length);
            }
            ...
            if (statistics != null) {
                statistics.recordQuery("BATCH", startTime, endTime, success);
            }
        }
    }
