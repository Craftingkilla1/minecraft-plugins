// ./src/main/java/com/minecraft/example/command/AdminCommand.java
...
public class AdminCommand implements com.minecraft.core.command.TabCompletionProvider {
    ...
    public void resetStat(CommandSender sender, String[] args) {
        ...
        if (targetPlayer != null) {
            ...
            statsService.getPlayerStatsByName(playerName)
                .ifPresentOrElse(
                    stats -> resetStatForUuid(sender, stats.getUuid(), playerName, statType),
